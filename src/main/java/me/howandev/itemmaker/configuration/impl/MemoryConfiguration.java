package me.howandev.itemmaker.configuration.impl;
...
public class MemoryConfiguration implements Configuration {
    ...
    public MemoryConfiguration(final @Nullable Configuration parent) {
        this.parent = parent;
        this.root = (parent != null) ? parent.getRoot() : this;
        this.path = "";
        this.fullPath = (parent != null) ? createPath(parent, root, path) : "";
    }

    public MemoryConfiguration(final @Nullable Configuration parent, final @Nullable String path) {
        this.parent = parent;
        this.root = (parent != null) ? parent.getRoot() : this;

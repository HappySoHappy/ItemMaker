package me.howandev.itemmaker.configuration.impl.file.yaml;
...
public class YamlRepresenter extends Representer {
    ...
    private class RepresentCustomSerializedMap extends RepresentMap {
        ...
        public Node representData(Object data) {
            ...
            if (serializer != null) {
                //System.out.printf("Using '%s' for '%s' (%s)%n", serializer.getClass().getSimpleName(), data.getClass().getName(), data);

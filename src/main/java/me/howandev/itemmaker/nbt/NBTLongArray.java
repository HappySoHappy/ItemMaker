...
public final class NBTLongArray implements NBTValue<long[]>, NBT, NBTArray<Long> {
    ...
    NBTLongArray(final Object value) {
        this((long[]) value);
    }

    public NBTLongArray(final InputStream stream) throws IOException {
        this(decodeLongs(stream));
    }

    static long[] decodeLongs(final InputStream stream) throws IOException {
    ...
    public void write(final OutputStream stream) throws IOException {
        ...
        for (final long j : value) NBTLong.encodeLong(stream, j);
    }
    ...
    public boolean equals(final Object o) {
        ...
        final NBTLongArray nbtLongArray = (NBTLongArray) o;

...
public interface NBT extends Cloneable {
    ...
    static NBT convert(Object value) {
        ...
        for (final Tag tag : Tag.values()) for (final Class<?> type : tag.types) if (type.isInstance(value)) return tag.make(value);
    ...
    enum Tag implements Type {
        ...
        Tag(final Function<Object, NBT> make, final Function<NBT, Object> revert, final Class<?>... types) {
            this.make = make;
            this.revert = revert;
            this.types = types;
        }
        ...
        public NBT make(final Object value) {
            return make.apply(value);
        }

        public Object revert(final NBT nbt) {

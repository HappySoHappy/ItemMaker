...
import me.howandev.itemmaker.nbt.NBTByte;
...
class NBTValueParser implements NBTElementParser<NBT> {
    ...
    private static int findClosingBrace(final String string) {
        if (string.charAt(0) != '{')
            return -1;

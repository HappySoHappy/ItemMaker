...
public final class NBTByteArray implements NBTValue<byte[]>, NBT, NBTArray<Byte> {
    ...
    NBTByteArray(final Object value) {
        this((byte[]) value);
    }

    public NBTByteArray(final InputStream stream) throws IOException {
        this(decodeBytes(stream));
    }

    static byte[] decodeBytes(final InputStream stream) throws IOException {
    ...
    public boolean equals(final Object o) {
        ...
        final NBTByteArray bytes = (NBTByteArray) o;
